...
<p>
<form method="post" action="resultnine.php">  
  ...
  <br><br>
  Congentital:
  <input type="radio" name="congentital" value="yes">Yes
  <input type="radio" name="congentital" value="no">No
  <br><br>
  Foodlose:
  <input type="radio" name="foodlose" value="yes">Yes
  <input type="radio" name="foodlose" value="no">No
  <br><br>
